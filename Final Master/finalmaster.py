...
def checkebay():
    ...
    op= 'Website if you want to visit the store : ' + ebay_url
    labeloutput = Label( root , text = op )
...
def checkSnapdeal():
    ...
    op = 'Website if you want to visit the store : ' + snapdeal_url
...
def checkShopclue():
    ...
    op='Website if you want to visit the store : ' + shop_url
    labeloutput = Label( root , text = op )
...
def checkPaytmMall():
    ...
    op='Website if you want to visit the store : '+paytm_url
    labeloutput = Label( root , text = op )
